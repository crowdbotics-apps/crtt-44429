"""
Django settings for crtt_44429 project.
...
WSGI_APPLICATION = 'crtt_44429.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "crtt_44429 API",
    "DESCRIPTION": "API documentation for crtt_44429 App",
    "VERSION": "v1",
}
